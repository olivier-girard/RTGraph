...
"}"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "                                                                                   Energie deposite:", None))
        self.EnergieDep.setText(_translate("MainWindow", "0", None))
        self.display.setTabText(self.display.indexOf(self.tracker), _translate("MainWindow", "2D trace", None))
        self.display.setTabText(self.display.indexOf(self.threed), _translate("MainWindow", "3D trace", None))
        self.display.setTabText(self.display.indexOf(self.histogram), _translate("MainWindow", "Histogram", None))
