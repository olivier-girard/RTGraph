...
class Ui_DisplayModeWindow(object):
    def setupUi(self, DisplayModeWindow):
        ...
        DisplayModeWindow.resize(1362, 911)
        DisplayModeWindow.setMinimumSize(QtCore.QSize(1362, 911))
        DisplayModeWindow.setMaximumSize(QtCore.QSize(1362, 911))
...
""))
        ...
        self.EnergieDep.setText(_fromUtf8(""))
        self.EnergieDep.setObjectName(_fromUtf8("EnergieDep"))
        self.horizontalLayout.addWidget(self.EnergieDep)
        self.gridLayout.addLayout(self.horizontalLayout, 1, 0, 1, 1)
        self.gridLayout_2 = QtGui.QGridLayout()
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.display = QtGui.QTabWidget(self.centralwidget)
        self.display.setMinimumSize(QtCore.QSize(1040, 0))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("URW Bookman L"))
...
"}"))
        ...
        self.plttracker.setStyleSheet(_fromUtf8(""))
        ...
        self.plt3d = GLViewWidget(self.tab)
        self.plt3d.setObjectName(_fromUtf8("plt3d"))
        self.gridLayout_13.addWidget(self.plt3d, 1, 0, 1, 1)
        self.display.addTab(self.tab, _fromUtf8(""))
        ...
        self.plthisto = GraphicsLayoutWidget(self.histogram)
        self.plthisto.setObjectName(_fromUtf8("plthisto"))
        self.gridLayout_7.addWidget(self.plthisto, 0, 0, 1, 1)
        ...
        self.gridLayout_4 = QtGui.QGridLayout(self.channel)
        ...
        self.gridLayout_3.addWidget(self.pltchannel, 0, 0, 1, 1)
    ...
    def retranslateUi(self, DisplayModeWindow):
        DisplayModeWindow.setWindowTitle(_translate("DisplayModeWindow", "Saved window", None))
        self.label_2.setText(_translate("DisplayModeWindow", "                                        Energie deposite :", None))
        self.display.setTabText(self.display.indexOf(self.tracker), _translate("DisplayModeWindow", "2D trace", None))
        self.display.setTabText(self.display.indexOf(self.tab), _translate("DisplayModeWindow", "3D trace", None))
        self.display.setTabText(self.display.indexOf(self.histogram), _translate("DisplayModeWindow", "Histogram", None))
        self.display.setTabText(self.display.indexOf(self.frequency), _translate("DisplayModeWindow", "Frequency", None))
        self.display.setTabText(self.display.indexOf(self.channel), _translate("DisplayModeWindow", "Channel", None))
