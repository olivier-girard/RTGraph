...
"}"))
        ...
        self.Layout_graphs.addLayout(self.horizontalLayout_5, 5, 0, 1, 1)
        ...
        self.Layout_controls.addWidget(self.cmdLineEdit, 3, 1, 1, 1)
        ...
        self.Layout_controls.addLayout(self.horizontalLayout, 3, 5, 1, 1)
        ...
        self.Layout_controls.addWidget(self.label, 3, 0, 1, 1)
        self.pButton_Stop = QtGui.QPushButton(self.centralwidget)
        self.pButton_Stop.setObjectName(_fromUtf8("pButton_Stop"))
        self.Layout_controls.addWidget(self.pButton_Stop, 0, 5, 1, 1)
        self.label_3 = QtGui.QLabel(self.centralwidget)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.Layout_controls.addWidget(self.label_3, 3, 3, 1, 1)
        self.lineEdit_Save_as = QtGui.QLineEdit(self.centralwidget)
        self.lineEdit_Save_as.setObjectName(_fromUtf8("lineEdit_Save_as"))
        self.Layout_controls.addWidget(self.lineEdit_Save_as, 3, 4, 1, 1)
        self.Layout_graphs.addLayout(self.Layout_controls, 2, 0, 1, 1)
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 954, 32))
        self.menuBar.setObjectName(_fromUtf8("menuBar"))
        self.menuReload = QtGui.QMenu(self.menuBar)
        self.menuReload.setObjectName(_fromUtf8("menuReload"))
        ...
        self.menuReload.addAction(self.actionAll_pannel)
        self.menuReload.addSeparator()
        self.menuReload.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sensorConfFile.setText(_translate("MainWindow", "setup_examples/geometry_pebs_approx.csv", None))
        ...
        self.cmdLineEdit.setText(_translate("MainWindow", "./fake_track_pebs.py", None))
        ...
        self.label_3.setText(_translate("MainWindow", "Save as", None))
        self.menuReload.setTitle(_translate("MainWindow", "reload", None))
