...
""))
        ...
        self.integration_bt = QtGui.QPushButton(self.frame)
        self.integration_bt.setMinimumSize(QtCore.QSize(50, 0))
        self.integration_bt.setObjectName(_fromUtf8("integration_bt"))
        self.horizontalLayout_2.addWidget(self.integration_bt)
...
""))
    ...
    def retranslateUi(self, CommandWindow):
        ...
        self.integration_bt.setText(_translate("CommandWindow", "Integration mode", None))
