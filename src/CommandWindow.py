...
""))
        ...
        self.gridLayout.addWidget(self.lineEdit_SensorPos, 11, 1, 1, 6)
        self.rotation = QtGui.QPushButton(self.frame)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("URW Bookman L"))
...
""))
        ...
        self.gridLayout.addWidget(self.btnSavedPause, 2, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnSavedLeft, 2, 7, 1, 1)
...
""))
        ...
        self.gridLayout.addLayout(self.gridLayout_8, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnSavedRight, 2, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnSavedStart, 2, 5, 1, 1)
...
""))
        ...
        self.gridLayout.addWidget(self.pushButton_LIVE, 0, 1, 2, 1)
...
""))
        ...
        self.gridLayout.addLayout(self.gridLayout_6, 4, 4, 1, 5)
...
""))
        ...
        self.gridLayout.addWidget(self.sensorLoadbtn, 11, 7, 1, 2)
...
""))
        ...
        self.gridLayout.addWidget(self.setupLoadbtn, 9, 7, 1, 2)
        ...
        self.radioButton_muondecay_sd = QtGui.QRadioButton(self.frame)
        self.radioButton_muondecay_sd.setText(_fromUtf8(""))
        self.radioButton_muondecay_sd.setAutoExclusive(True)
        self.radioButton_muondecay_sd.setObjectName(_fromUtf8("radioButton_muondecay_sd"))
        self.buttonGroup_2.addButton(self.radioButton_muondecay_sd)
        self.gridLayout_4.addWidget(self.radioButton_muondecay_sd, 2, 1, 1, 1)
        self.muondecay_Ind_sd = QtGui.QLCDNumber(self.frame)
        self.muondecay_Ind_sd.setObjectName(_fromUtf8("muondecay_Ind_sd"))
        self.gridLayout_4.addWidget(self.muondecay_Ind_sd, 2, 2, 1, 1)
        ...
        self.gridLayout.addLayout(self.gridLayout_4, 5, 4, 1, 5)
...
""))
        ...
        self.gridLayout.addWidget(self.pushButton_SavedData, 0, 3, 2, 7)
        ...
        self.radioButton_muondecay = QtGui.QRadioButton(self.frame)
        self.radioButton_muondecay.setText(_fromUtf8(""))
        self.radioButton_muondecay.setAutoExclusive(True)
        self.radioButton_muondecay.setObjectName(_fromUtf8("radioButton_muondecay"))
        self.buttonGroup.addButton(self.radioButton_muondecay)
        self.gridLayout_3.addWidget(self.radioButton_muondecay, 2, 0, 1, 1)
        self.muondecay_Ind = QtGui.QLCDNumber(self.frame)
        self.muondecay_Ind.setObjectName(_fromUtf8("muondecay_Ind"))
        self.gridLayout_3.addWidget(self.muondecay_Ind, 2, 2, 1, 1)
...
""))
        ...
        self.gridLayout.addLayout(self.gridLayout_9, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_DataPath, 6, 4, 1, 4)
...
""))
        ...
        self.gridLayout.addWidget(self.DataLoadbtn, 6, 8, 1, 1)
...
""))
        ...
        self.gridLayout.addLayout(self.gridLayout_11, 6, 1, 1, 1)
        ...
        self.gridLayout.addLayout(self.gridLayout_10, 6, 0, 1, 1)
...
""))
        ...
        self.gridLayout.addWidget(self.rotation_saved, 4, 3, 1, 1)
        ...
        self.gridLayout_25.addWidget(self.poster, 1, 0, 1, 1)
    ...
    def retranslateUi(self, CommandWindow):
        ...
        self.label_9.setText(_translate("CommandWindow", "Muon Decay", None))
        self.label_10.setText(_translate("CommandWindow", "Electron E>>", None))
        ...
        self.label_17.setText(_translate("CommandWindow", "Electron E>>", None))
        self.label_6.setText(_translate("CommandWindow", "Electron", None))
        self.label_16.setText(_translate("CommandWindow", "Muon Decay", None))
