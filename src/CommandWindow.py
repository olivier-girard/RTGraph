...
""))
        ...
        self.gridLayout.addWidget(self.lineEdit_SensorPos, 10, 1, 1, 6)
...
"background:qlineargradient(spread:reflect, x1:0, y1:1, x2:1, y2:1, stop:0.0948276 rgba(136, 106, 22, 255), stop:0.185345 rgba(40, 5, 5, 255), stop:0.376179 rgba(223, 215, 102, 255), stop:0.399142 rgba(137, 108, 26, 255), stop:0.407725 rgba(204, 181, 74, 255), stop:0.420601 rgba(202, 174, 68, 255), stop:0.424893 rgba(166, 140, 41, 255), stop:0.429185 rgba(14, 14, 11, 255), stop:0.52 rgba(209, 190, 76, 255), stop:0.625 rgba(187, 156, 51, 255), stop:0.698276 rgba(168, 142, 42, 255), stop:0.814655 rgba(218, 202, 86, 255), stop:0.853448 rgba(208, 187, 73, 255), stop:0.931034 rgba(22, 26, 1, 255), stop:0.987069 rgba(187, 156, 51, 255));"))
        ...
        self.gridLayout.addWidget(self.btnSavedPause, 3, 6, 1, 1)
...
""))
        ...
        self.gridLayout.addLayout(self.gridLayout_8, 6, 0, 1, 1)
...
""))
        ...
        self.gridLayout.addWidget(self.label_logo, 0, 0, 5, 1)
...
""))
        ...
        self.gridLayout.addWidget(self.sensorLoadbtn, 10, 7, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_DataPath, 7, 4, 1, 4)
...
""))
        ...
        self.gridLayout.addLayout(self.gridLayout_11, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnSavedLeft, 3, 7, 1, 1)
...
""))
        ...
        self.gridLayout.addLayout(self.gridLayout_6, 5, 4, 1, 5)
        ...
        self.gridLayout.addWidget(self.btnSavedRight, 3, 8, 1, 1)
...
""))
        ...
        self.gridLayout.addWidget(self.DataLoadbtn, 7, 8, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_Event, 3, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnSavedStart, 3, 5, 1, 1)
...
""))
        ...
        self.automatic_bt.setMinimumSize(QtCore.QSize(100, 50))
        ...
        self.gridLayout.addWidget(self.automatic_bt, 2, 1, 1, 1)
        ...
        self.gridLayout.addLayout(self.gridLayout_4, 6, 5, 1, 4)
...
""))
        ...
        self.gridLayout.addLayout(self.gridLayout_9, 6, 3, 1, 2)
        ...
        self.biasON = QtGui.QPushButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_14.addWidget(self.biasON, 0, 0, 1, 1)
        self.biasOFF = QtGui.QPushButton(self.groupBox)
        self.biasOFF.setMinimumSize(QtCore.QSize(0, 0))
        self.biasOFF.setMaximumSize(QtCore.QSize(16777215, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_14.addWidget(self.biasOFF, 0, 1, 1, 1)
        self.gridLayout_25.addWidget(self.groupBox, 1, 0, 1, 1)
    ...
    def retranslateUi(self, CommandWindow):
        CommandWindow.setWindowTitle(_translate("CommandWindow", "Control Window", None))
        ...
        self.lineEdit_DataPath.setText(_translate("CommandWindow", "/home/lphe/cosmic_analysis/python-scripts/RTGraph/data_example.csv", None))
        ...
        self.label_2.setText(_translate("CommandWindow", "Go to event:", None))
        ...
        self.groupBox.setTitle(_translate("CommandWindow", "Bias Voltage", None))
        self.biasON.setText(_translate("CommandWindow", "ON", None))
        self.biasOFF.setText(_translate("CommandWindow", "OFF", None))
